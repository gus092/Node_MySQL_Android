    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_all.setOnClickListener(new View.OnClickListener() { //GET ALL버튼을 누르면
                                       ...
                                       public void onClick(View view) {
                                           new JSONTask1().execute("http://192.168.35.25:3306/person");
                                       }
                                   }
        );
        btn_post.setOnClickListener(new View.OnClickListener() { //POST버튼을 누르면
            @Override
            public void onClick(View view) {
                new JSONTask2().execute("http://192.168.35.25:3306/post" ); //(1)이벤트 발생후 호출
            }
        });
        ...
        btn_insert.setOnClickListener(new View.OnClickListener() { //insert DB 버튼을 누르면
            @Override
            public void onClick(View view) {
                new JSONTask3().execute("http://192.168.35.25:3306/insert" ); //(1)이벤트 발생후 호출
            }
        });
    ...
    public class JSONTask3 extends AsyncTask<String, String, String>{
        ...
        protected String doInBackground(String... urls) {
            try {
                ...
                jsonObject.accumulate("name", "insert_name"); //(2)찾으려는 요소 넣기
                jsonObject.accumulate("address", "insert_address");
                jsonObject.accumulate("email", "insert_email");
                jsonObject.accumulate("phone", "insert_phone");
